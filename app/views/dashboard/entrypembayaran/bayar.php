...
<div class="modal fade" id="bayarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-user="<?= $siswa['id'] ?>">
...
<script>
    ...
    buttonPayModal.addEventListener('click', async (e) => {
        ...
        await fetch("http://localhost/pembayaran_spp/public/dashboard/processbayar/1", {
            method: "POST",
            body: formData
        })
    })
