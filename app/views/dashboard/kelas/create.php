...
<div class="card shadow my-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                <div class="p-1">
                    <form action="<?= BASEURL ?>/dashboard/storekelas" method="POST" class="user">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user br-10" name="kompetensi_keahlian" required>
                        </div>
